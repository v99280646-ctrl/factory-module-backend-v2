...
subscriptionRoutes.get("/plans", async (_req, res) => {
  const plans = await ensureDefaultSubscriptionPlans();
  ok(res, plans.map(mapPlan));
});

subscriptionRoutes.post("/plans", async (req, res) => {
...
subscriptionRoutes.patch("/plans/:id", async (req, res) => {
...
subscriptionRoutes.get("/factories", async (req, res) => {
...
subscriptionRoutes.get("/factories/:factoryId/history", async (req, res) => {
...
subscriptionRoutes.get("/history", async (req, res) => {
...
subscriptionRoutes.post("/factories/:factoryId/assign", async (req, res) => {
...
subscriptionRoutes.post("/factories/:factoryId/renew", async (req, res) => {
...
subscriptionRoutes.post("/factories/:factoryId/cancel", async (req, res) => {
