...
export async function handleListWaste(req, res) {
...
export async function handleUpdateWaste(req, res) {
...
export async function handleDeleteWaste(req, res) {
    const filter = req.user?.globalRole === "super_admin" ? {} : { factoryId: req.factoryId };
